...
/**
 * Event Handler to Cut and Paste Part of the Onscreen Image
 * 
 * @author Alex Appel
 */
public class copyHandler implements EventHandler<ActionEvent> {
    ...
    /**
     * Set phase of copyHandler (Normally 2)
    ...
    /**
     * Event Handler to Copy and Paste Part of the Onscreen Image
     * @param coolCrab Main Program StackPane
     * @param tabPane Main Program TabPane
     */
    public copyHandler(StackPane coolCrab, TabPane tabPane){
    ...
    public void handle(ActionEvent a) {
        ...
        hold = 0;                                                               // Set Hold
        PaintFX.logItem("Copy and Paste", 1);                                   // Log Save
