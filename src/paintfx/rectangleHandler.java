...
public class rectangleHandler implements EventHandler<ActionEvent> {
    ...
    /**
     * Set phase of rectangleHandler (Normally 2)
     ...
     */
    public rectangleHandler(StackPane coolCrab, ColorPicker colorPicker, ColorPicker fillPick, TextField widthText, ToggleButton rectBtn, TabPane tabPane, CheckBox fillBox, ToggleButton dropBtn, ToggleButton dropBtn1){
    ...
    public void handle(ActionEvent a) {
        ...
        hold = 0;                                                               // Set holds
        PaintFX.logItem("Rectangle", 1);                                        // Log Save
        ...
        if(PaintFX.getSelec() == 0){                                            // Take Snapshot for current tab
        ...
        canTemp.setOnMouseDragged((event) ->{
            if(hold == 0 && rectBtn.isSelected()){                              // When Mouse Dragged
                ...
                if(dropBtn1.isSelected()){                                      // Get Fill Color
                    ...
                    gcTemp.setFill(fillPick.getValue());                        // Set Edge Color to selected value
                }
        ...
        canTemp.setOnMouseReleased((event) ->{
            if(hold == 0 && rectBtn.isSelected()){                              // When mouse released
                gcTemp.clearRect(canTemp.getLayoutBounds().getMinX(), canTemp.getLayoutBounds().getMinY(), canTemp.getWidth(), canTemp.getHeight());
                gcTemp.drawImage(image, 0, 0);
                x2 = event.getX();                                              // Record Coordinates
                y2 = event.getY();
                ...
                if(PaintFX.getSelec() == 0){                                    // For selected tab
                    ...
                    PaintFX.canvasPush(canTemp);                                // Add new canvas to stack
                }
